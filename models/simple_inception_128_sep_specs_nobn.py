...
def model_fn(features, labels, mode, params):
  ...
  x = tf.layers.conv2d(features, filters=16, kernel_size=7, activation=None, name='l1')
  ...
  x = util.inception_block(x, t1x1=32, t3x3=42, t5x5=16, tmp=16, training=training, norm=False, name='3_incep_1')
  x = util.inception_block(x, t1x1=64, t3x3=128, t5x5=52, tmp=43, training=training, norm=False, name='4_incep_2')
  x = tf.layers.max_pooling2d(x, pool_size=3, strides=2, name='maxpool3')
  tf.summary.image('3_1maxpool', x[:, :, :, 0:3], max_outputs=4)

  x = util.inception_block(x, t1x1=96, t3x3=128, t5x5=16, tmp=16, training=training, norm=False, name='6_incep_3')
  x = util.inception_block(x, t1x1=96, t3x3=128, t5x5=16, tmp=16, training=training, norm=False, name='7_incep_4')
...
#  tf.summary.image('9_maxpool', x[:, :, :, 0:3], max_outputs=4)
  ...
  x = util.inception_block(x, t1x1=128, t3x3=256, t5x5=32, tmp=16, training=training, norm=False, name='10_incep_7')
  x = util.inception_block(x, t1x1=128, t3x3=256, t5x5=32, tmp=16, training=training, norm=False, name='11_incep_8')
